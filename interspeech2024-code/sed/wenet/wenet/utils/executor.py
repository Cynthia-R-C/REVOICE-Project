...
class Executor:
    ...
    def train(self, model, optimizer, scheduler, data_loader, device, writer,
        ...
        '''
        if DEBUG:
            print("\n[Personal debug] Inside executor.train function.\n")
        model.train()
        ...
        if DEBUG:
            print("\n[Personal debug] Starting batches over data_loader...\n")
        with model_context():
            for batch_idx, batch in enumerate(data_loader):
                if DEBUG:
                    print("\n[Personal debug] Inside batch loop of executor.train, forward pass-ish\n")
                ...
                if DEBUG:
                    print("\n[Personal debug] Calculating loss + backwards pass...\n")
                with context():

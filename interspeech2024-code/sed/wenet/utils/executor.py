...
from wenet.utils.train_utils import (wenet_join, batch_forward, batch_backward,
                                     ...
                                     save_model)
from wenet.utils.init_model import init_model  # added
...
class Executor:
    ...
    # Added; wrapper for init_model to match interspeech2024 train_sed.py expectations
    def build_model(self, configs, device=torch.device("cuda")):
        '''Compatibility wrapper for interspeech2024 code.
        Builds model, optimizer, and scheduler just like train_sed expects.'''
        from wenet.utils.init_model import init_model
        model, optimizer, scheduler = init_model(configs)
        print("[Info] build_model(): model + optimizer + scheduler initialized.")
